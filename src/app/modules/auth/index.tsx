...
export default function Auth() {
  ...
  return (
    <div key="auth-container" className="flex min-h-screen">
      ...
      <div className="hidden md:flex md:w-1/3 bg-gradient-to-br from-primary-300 to-secondary-400 flex-col items-center justify-between p-8">
        <div className="w-full">
          <Image
            src="/resources/login/logo-light.png"
            alt="Logo"
            width={100}
            height={32}
          />
        ...
        <div className="flex items-center justify-center">
          <Image
            src="/resources/login/graphic2.svg"
            alt="Login graphic"
            width={500}
            height={300}
          />
        </div>
        <div className="h-20"></div> {/* Espacio para información */}
      </div>
      ...
      >
        <div className="w-full max-w-xl">
          ...
          <h1 className="text-4xl font-bold text-neutral-50 mb-2">
            Bienvenido al Portal IoT
          </h1>
          <p className="text-blue-100 mb-8 text-2xl">
            Monitoreo inteligente para aplicaciones y servicios de IoT a escala
            web.
          </p>
